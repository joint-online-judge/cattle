export default [
  {
    ...
    routes: [
      ...
      { exact: true, path: '/domain/:domainUrl/create-problem-set', component: '@/pages/CreateProblemSet' },
      { exact: true, path: '/domain/:domainUrl/settings', component: '@/pages/DomainSettings' },
      { exact: true, path: '/domain/:domainUrl/records', component: '@/pages/RecordList' },
      { exact: true, path: '/domain/:domainUrl', component: '@/pages/DomainHome' },
      { exact: true, path: '/domain', component: '@/pages/DomainList' },

      { exact: true, path: '/problem-set/:problemSetId/create-problem', component: '@/pages/CreateProblem' },
      ...
      { exact: true, path: '/problem/:problemId/edit', component: '@/pages/Problem' },
      { exact: true, path: '/problem/:problemId/settings', component: '@/pages/Problem' },
